...
/datum/species/moth
	...
	id = "moth"
	desc = "<b>Fluvian</b><br>\
	Many comparisons have been made to the common moths in an attempt to describe this unique species. \
	From the appetite for clothing to the disconcertingly insectoid appearance, the name 'Moth' is forever stamped onto the common vocabulary. \
